    ...
    <div class="cart-flex">
      ...
      <div>
        ...
        <form action="" method="get">
          ...
          <div>
            <input v-model="street" placeholder="Street" type="text" required />
          </div>
          <div>
            <input
              v-model="postalCode"
          ...
          <div>
            <input v-model="phone" placeholder="Phone" type="number" required />
          </div>
          <div>
            <input v-model="mail" placeholder="E-mail" type="email" required />
          </div>
          <textarea
            v-model="address"
            placeholder="Address"
